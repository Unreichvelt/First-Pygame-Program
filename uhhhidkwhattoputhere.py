...
green_coin = pygame.image.load("Greencoin.png")
red_coin = pygame.image.load("Redcoin.png")
blue_coin = pygame.image.load("Bluecoin.png")
yellow_coin = pygame.image.load("Yellowcoin.png")
player_sprite = pygame.image.load("purple_circle.png")
